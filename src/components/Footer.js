...
// TODO - MAKE THIS ALL DYNAMIC IN WORDPRESS BACKEND
const Footer = () => (
  <FooterWrapper>
      ...
      <div className="row">
        <div className="col-md-4">
          ...
          <p className="tango-contact">
            <a href="mailto:anders@tangobrandalliance.se">anders@tangobrandalliance.se</a>
          </p>
          <p className="tango-contact">+46 (0) 706 531 992</p>
          <span className="social">
            <a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/anders-lindén-06893316/">
        ...
        <div className="col-md-4">
          ...
          <p className="tango-contact">
            <a href="mailto:mirelle@tangobrandalliance.se">mirelle@tangobrandalliance.se</a>
          </p>
        ...
        <div className="col-md-4">
          ...
          <span className="social">
            <a target="_blank" rel="noopener noreferrer" href="https://www.facebook.com/tangobrandalliance/">
              <img className="facebook" src={tangoFB} alt="tango-fb" />
            </a>
            <a target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/tangobrandalliance/">
